...
const SadDemon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path fill="hsl(var(--secondary-foreground))" d="M9 9h14v14H9z" />
    ...
    <path fill="hsl(var(--foreground))" d="M12 21h1v-1h6v1h1v-1h-8z" />
    <path fill="hsl(var(--background))" d="M14 16h-1v-1h1zm4 0h-1v-1h1z" />
  </svg>
);

export default SadDemon;
